      ...
      <tr>
        <td style="padding: 30px;">
          ...
          <p style="text-align: center; margin: 30px 0;">
            <a href="http://localhost:8000/api/v1/auth/resetPass/${generatedString}?email=${userEmail}" style="background-color: #007BFF; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">
              Reset Password
            </a>
          </p>
